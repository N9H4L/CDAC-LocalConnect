...
const services = [
  ...
  { name: "WASHING MACHINE REPAIR SERVICE", image: washingmachienJpg, id: 5 },
  { name: "BARBER SERVICE", image: barberJpg, id: 6 },
  { name: "CAR AND BIKE REPAIR SERVICE", image: carandbikeJpg, id: 7 },
  { name: "CLINIC SERVICE", image: clinicJpg, id: 8 },
    ...
    <div>
      <div className="service-list-container">
        {services.map((service) => (
          <div key={service.id} className="service-card" onClick={() => handleImageClick(service)}>
